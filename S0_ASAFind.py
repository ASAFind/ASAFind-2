...
parser.add_argument('-l', '--logomaker', action='store_true',
                    help='If chosen, the program will generate graphical output using logomaker, in .png and .svg formats. They will be included into the output compressed package.')
